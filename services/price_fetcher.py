...
def get_spot_price():
    provider = os.getenv("PRICE_PROVIDER","binance").lower()
    ...
    try:
        ...
        raise RuntimeError("Both Binance and CoinGecko failed to fetch spot price.")


def get_recent_minutes(limit=240):
    # ✅ اولویت با Binance OHLCV
    try:
